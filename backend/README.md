...
## Project Structure
    ...
    ├── testapiautostorybo_124689  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_124689`
...
2. Clone this repo and `cd testapiautostorybo_124689`
